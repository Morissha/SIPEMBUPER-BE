...
$sql = "SELECT p.id_peminjaman, b.judul_buku, k.nama_kategori as kategori, p.tanggal_pinjam as tgl_peminjaman, p.tanggal_pengembalian as tgl_pengembalian, p.status 
        FROM peminjaman p 
        JOIN buku b ON p.id_buku = b.id_buku 
        JOIN kategori k ON b.id_kategori = k.id_kategori 
        WHERE p.id_anggota = (SELECT id_anggota FROM anggota WHERE nim = '".$_SESSION['nim']."') 
